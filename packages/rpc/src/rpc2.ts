...
// const HostRpcSpec = {
//     register: {
//         params: [Configuration, WatchLeaf],
//     },
// };

// export abstract class IHostRpc {
//     constructor(
//         protected manager: AppsManager,
//         protected app: LambdaApp,
//         protected appRpc: VirtualRpc<AppRpc>
//     ) {}
...
//     abstract setSettings(appId: string, setting: object): void;
// }

// export class HostRpc extends IHostRpc {
//     async register(
//         configurations: Configuration[],
//         observables: WatchLeaf[][]
//     ) {
